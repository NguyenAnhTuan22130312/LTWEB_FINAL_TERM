  ...
  <body>
    ...
    <div id="containe">
      <div class="order-status-container">
        ...
        <button class="status-button" id="btn_delivered" onclick="showSection('alreadyDelivered')">Đã vận chuyển</button>
      ...
      <div id="rating-popup" class="popup">
        <div class="popup-content">
          ...
          <div class="product-rating">
            ...
            <div class="product-item">
              <img src="../Images/Food/Com/Com-chien-ga-xoi-mo.png" alt="Cơm gà xối mỡ" class="product-image" />
              <div class="product-info">
