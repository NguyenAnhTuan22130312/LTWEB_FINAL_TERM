              ...
              <div class="content-group">
                ...
                <div class="checkout-type-order">
                  ...
                  <button class="type-order-btn" id="tudenlay">
                    <i
                      class="fa-duotone fa-solid fa-box-taped"
                      style="
                        --fa-secondary-opacity: 1;
                        --fa-primary-color: #b5292f;
                        --fa-secondary-color: gray;
              ...
              <div class="content-group" id="tudenlay-group">
                ...
                <div class="delivery-time">
                  ...
                  <label for="chinhanh-1"
                    >Trường Đại học Nông Lâm Thành phố HCM phố 6, phường Linh
                    Trung, Thủ Đức</label
                  >
                </div>
                <div class="delivery-time">
                  ...
                  <label for="chinhanh-2"
                    >169/8, phường Dĩ An, TP. Dĩ An, Bình Dương</label
                  >
                </div>
              </div>
              <div class="content-group">
