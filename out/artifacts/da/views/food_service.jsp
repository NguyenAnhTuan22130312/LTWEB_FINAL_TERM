        ...
        <div class="menu_container">
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Cơm ba rọi rim tôm là một món ăn đậm đà hương vị, kết hợp giữa thịt ba rọi heo mềm mịn và tôm
                        tươi ngọt, tạo nên sự hòa quyện hoàn hảo.
                    </p>
                    <button>
                        Món cơm
                    </button>
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Cơm canh chua cá hú là một món ăn đậm đà và thanh mát, mang đặc trưng của ẩm thực miền Nam Việt
                        Nam.
                        Món canh chua cá hú được nấu từ những miếng cá hú tươi ngon, thịt cá mềm, ngọt, kết hợp với vị
                        chua nhẹ từ me và các loại rau thơm
                    </p>
                    <button>
                        Món cơm
                    </button>
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Cơm chiên bò lúc lắc là món ăn nổi bật với những miếng thịt bò mềm, thấm đẫm gia vị, kết hợp với
                        cơm chiên vàng ươm và rau củ giòn ngọt.
                    </p>
                    <button>
                        Món cơm
                    </button>
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Cơm chiên dưa bò là một món ăn kết hợp hoàn hảo giữa vị béo ngậy của cơm chiên, sự tươi mát của
                        dưa chua và vị ngọt mềm của thịt bò.
                    </p>
                    <button>
                        Món cơm
                    </button>
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Cơm chiên dương châu là món ăn đặc trưng của ẩm thực Trung Hoa, với cơm chiên thơm lừng kết hợp
                        với thịt gà, tôm, trứng và rau củ tươi ngon.
                    </p>
                    <button>
                        Món cơm
                    </button>
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Cơm gà xối mỡ là món ăn truyền thống với thịt gà được chiên giòn rụm, kết hợp cùng cơm trắng dẻo
                        thơm và các loại rau sống tươi mát.
                    </p>
                    <button>
                        Món cơm
                    </button>
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Cơm mực trứng muối là món ăn thơm ngon với mực tươi, trứng muối béo ngậy, hòa quyện cùng cơm
                        chiên mềm và gia vị đậm đà.
                    </p>
                    <button>
                        Món cơm
                    </button>
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Cơm đậu hũ kho cà ri là món ăn vừa ngon lại vừa dễ ăn với đậu hũ mềm được kho thấm gia vị cà ri
                        đặc trưng.
                    </p>
                    <button>
                        Món cơm
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Cơm đậu hũ kho sườn chay là một món ăn thanh đạm, phù hợp cho những ai muốn thưởng thức ẩm thực
                        chay.
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Cơm gà kho sả ớt là món ăn đậm đà hương vị với thịt gà thơm ngon, thấm đẫm gia vị sả và ớt cay
                        nồng.
                        Vị ngọt tự nhiên của gà kết hợp cùng hương thơm của sả và vị cay nhẹ của ớt tạo nên món ăn hấp
                        dẫn.
                    </p>
                    <button>
                        Món cơm
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Món cơm giò heo kho cải chua là sự kết hợp hoàn hảo giữa giò heo kho mềm ngon, đậm đà gia vị, ăn
                        kèm với cải chua làm món ăn thêm phần hấp dẫn.
                    </p>
                    <button>
                        Món cơm
                    </button>
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Cơm mực xào là món ăn ngon với mực tươi xào cùng gia vị đậm đà, tạo ra sự kết hợp hoàn hảo với
                        cơm trắng.
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        ...
                        Miếng sườn được nấu mềm, ngấm vị ngọt của dừa và nước mắm, tạo nên một món ăn hấp dẫn, ngon
                        miệng.
                    </p>
                    <button>
                        Món cơm
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Cơm tấm đùi gà chiên là món ăn phổ biến với đùi gà giòn rụm, cơm tấm mềm dẻo và chén nước mắm
                        pha đặc trưng.
                    </p>
                    <button>
                        Món cơm
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        ...
                        Sườn nướng thơm ngon, bì giòn và chả lụa béo ngậy được kết hợp với cơm tấm dẻo, tạo nên một món
                        ăn ngon
                    </p>
                    <button>
                        Món cơm
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        ...
                        thấm đẫm gia vị. Khi ăn kèm với cơm tấm dẻo và nước mắm pha, món ăn này mang lại cảm giác thỏa
                        mãn
                    </p>
                    <button>
                        Món cơm
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Cơm tấm thịt kho Đài Loan với thịt kho mềm, thấm đẫm gia vị, nước kho đậm đà, ăn kèm với cơm tấm
                        dẻo, tạo nên một món ăn rất đặc biệt.
                    </p>
                    <button>
                        Món cơm
                    </button>
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Cơm thịt kho mắm ruốc có hương vị đặc trưng của mắm ruốc kết hợp với thịt kho mềm, nước kho đậm
                        đà.
                        Món ăn này mang lại cảm giác thỏa mãn, vừa cay cay vừa mặn mà, ăn kèm với cơm tấm là một sự kết
                        hợp tuyệt vời
                    </p>
                    <button>
                        Món cơm
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Cơm thịt kho tiêu là món ăn quen thuộc với hương vị đặc trưng của thịt heo kho đậm đà, kết hợp
                        với tiêu đen thơm nồng.
                    </p>
                    <button>
                        Món cơm
                    </button>
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Cơm thịt kho trứng là món ăn quen thuộc với sự kết hợp giữa thịt kho mềm ngọt và trứng kho thơm,
                        đậm đà.
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Cơm thịt luộc cà pháo là món ăn dân dã nhưng rất ngon miệng, với thịt luộc tươi ngon ăn kèm với
                        cà pháo muối chua, tạo nên hương vị đậm đà, dễ ăn
                    </p>
                    <button>
                        Món cơm
                    </button>
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Cơm trứng cuộn thịt là món ăn đơn giản nhưng đầy đủ dinh dưỡng, với trứng cuộn mềm mại, bên
                        trong là thịt xay thơm ngon.
                    </p>
                    <button>
                        Món cơm
                    </button>
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        ...
                        Chả được làm từ thịt heo xay nhuyễn, nêm gia vị rồi nướng trên than hồng, mang lại hương vị đặc
                        trưng
                    </p>
                    <button>
                        Món bún
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Bún Huế chay là món ăn thuần Việt mang đậm hương vị miền Trung, nhưng không sử dụng thịt mà thay
                        vào đó là những nguyên liệu chay thanh đạm
                    </p>
                    <button>
                        Món bún
                    </button>
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Món bún măng gà hấp dẫn với thịt gà mềm, măng tươi giòn, hòa quyện trong nước dùng thanh ngọt,
                        đậm đà.
                        Được trang trí với hành phi và rau sống tươi ngon, tạo nên một bữa ăn vừa bổ dưỡng vừa thơm
                        ngon.
                    </p>
                    <button>
                        Món bún
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Bún nem thịt nướng là sự kết hợp hoàn hảo giữa nem nướng thơm lừng và thịt heo nướng xém vàng,
                        chín mềm.
                        Món ăn được ăn kèm với bún tươi, rau sống và nước mắm chua ngọt, mang đến hương vị đậm đà khó
                        quên.
                    </p>
                    <button>
                        Món bún
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Bún thịt luộc mắm nêm là món ăn dân dã với thịt heo luộc thái mỏng, ăn kèm rau sống tươi ngon và
                        mắm nêm đậm đà.
                        Món ăn này mang lại sự hòa quyện giữa vị ngọt của thịt, vị mặn của mắm nêm và độ tươi mát của
                        rau sống.
                    </p>
                    <button>
                        Món bún
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Bún thịt nướng là món ăn quen thuộc với thịt heo nướng thơm ngon, giòn rụm, kết hợp với bún
                        tươi, rau sống và đậu phộng rang.
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Phở bò chín là món ăn phổ biến với thịt bò được ninh mềm, tạo ra hương vị đậm đà kết hợp cùng
                        nước dùng thanh, ngọt từ xương bò.
                        Món ăn thường được ăn kèm với bánh phở mềm, hành lá, rau thơm và thêm chút chanh, ớt để tăng
                        hương vị.
                    </p>
                    <button>
                        Món phở
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Phở bò tái là món phở được yêu thích nhờ sự hòa quyện của thịt bò tươi tái và nước dùng thanh,
                        ngọt từ xương bò.
                    </p>
                    <button>
                        Món phở
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Phở bò viên là sự kết hợp giữa nước dùng đậm đà, thanh ngọt và những viên bò được làm từ thịt bò
                        xay nhuyễn, gia vị, tạo độ dai, giòn đặc trưng.
                    </p>
                    <button>
                        Món phở
                    </button>
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        ...
                        hòa quyện cùng bánh phở mềm và các nguyên liệu như thịt gà xé, thịt lợn quay giòn, lạc rang, và
                        rau thơm.
                    </p>
                    <button>
                        Món phở
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Phở cuốn chiên phồng mang hương vị lạ miệng khi bánh phở được cuốn chặt và chiên vàng giòn bên
                        ngoài, giữ lại nhân thịt hoặc tôm, rau củ bên trong.
                    </p>
                    <button>
                        Món phở
                    </button>
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Phở cuốn Ngũ Xá nổi tiếng với những lát bánh phở mềm, cuốn chặt thịt bò xào thơm ngon cùng rau
                        sống.
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Phở cuốn thịt heo là sự kết hợp giữa bánh phở mềm và thịt heo luộc hoặc nướng, tạo nên hương vị
                        thơm ngon, dễ ăn.
                    </p>
                    <button>
                        Món phở
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Phở cuốn tôm chua mang đậm hương vị đặc trưng của miền Trung với tôm chua, bánh phở mềm mịn và
                        các loại rau sống.
                        Nhân cuốn có vị chua nhẹ của tôm lên men, cùng rau thơm, xà lách, tạo nên món ăn lạ miệng, hấp
                        dẫn
                    </p>
                    <button>
                        Món phở
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Phở gà là món ăn truyền thống với nước dùng trong, ngọt thanh được ninh từ xương gà, kết hợp
                        cùng thịt gà thơm, mềm.
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Phở hải sản là sự kết hợp độc đáo giữa nước dùng thơm ngọt từ hải sản như tôm, mực và cua. Bánh
                        phở mềm, ăn kèm các loại hải sản tươi ngon,
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Phở heo là biến tấu từ phở truyền thống với nước dùng được ninh từ xương heo, tạo độ ngọt thanh
                        tự nhiên.
                    </p>
                    <button>
                        Món phở
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Phở xào giòn là món ăn với bánh phở được chiên giòn rụm, kết hợp cùng thịt bò, hải sản hoặc rau
                        củ xào.
                        Nước sốt sệt đậm đà chan lên lớp phở giòn tan, tạo nên sự cân bằng giữa độ giòn và độ mềm trong
                        từng miếng ăn.
                    </p>
                    <button>
                        Món phở
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Phở xào hải sản là món ăn được yêu thích nhờ sự kết hợp giữa bánh phở dai, mềm và các loại hải
                        sản tươi ngon như tôm, mực, và cá.
                    </p>
                    <button>
                        Món phở
                    </button>
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        ...
                        chua cay nhờ nước sốt được pha từ gia vị truyền thống Thái như nước mắm, ớt, nước cốt chanh và
                        thảo mộc.
                    </p>
                    <button>
                        Món phở
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Phở xào rau cải là món ăn đơn giản nhưng không kém phần hấp dẫn với bánh phở xào cùng rau cải
                        xanh tươi.
                        Rau cải được xào nhanh tay giữ độ giòn và màu sắc xanh mướt, kết hợp cùng bánh phở dai mềm, gia
                        vị đậm đà.
                    </p>
                    <button>
                        Món phở
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Phở xốt vang là món ăn độc đáo kết hợp giữa phở truyền thống và thịt bò hầm xốt vang, một kiểu
                        hầm bò mang hương vị phương Tây.
                        Thịt bò mềm, thấm gia vị, hòa quyện với nước dùng xốt vang đậm đà, thơm lừng vị rượu vang và các
                        loại thảo mộc.
                    </p>
                    <button>
                        Món phở
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Phở gà trộn là món ăn hấp dẫn với bánh phở mềm trộn cùng thịt gà xé dai ngon, thường được thêm
                        hành phi, lạc rang, rau thơm và các loại gia vị.
                    </p>
                    <button>
                        Món phở
                    </button>
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Phở xào thịt băm là sự kết hợp hài hòa giữa bánh phở dai mềm và thịt băm nhỏ, được xào cùng gia
                        vị thơm phức. Món này thường được thêm hành lá,
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Chanh muối là thức uống giải khát truyền thống với vị chua ngọt và chút mặn nhẹ, giúp thanh lọc
                        cơ thể và giải nhiệt nhanh chóng.
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Espresso là loại cà phê đậm đà, được pha chế từ máy với áp suất cao, tạo nên lớp bọt mịn trên bề
                        mặt.
                        Đây là thức uống yêu thích cho những ai cần sự tỉnh táo và thích hương vị mạnh mẽ của cà phê
                        nguyên chất.
                    </p>
                    <button>
                        Đồ nước
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Latte là sự kết hợp hài hòa giữa cà phê espresso và sữa tươi được đánh nóng, tạo nên lớp bọt sữa
                        mềm mịn,
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Matcha Latte là sự kết hợp giữa bột trà xanh nguyên chất và sữa tươi, tạo nên vị ngọt nhẹ, thơm
                        mát và hơi đắng đặc trưng của matcha.
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Nước cam tươi ép là thức uống bổ dưỡng, giàu vitamin C, giúp tăng cường miễn dịch và cung cấp
                        năng lượng tức thì.
                        Hương vị cam ngọt mát, thơm ngon, là lựa chọn hoàn hảo cho những ngày hè oi bức hoặc khi bạn cần
                        sự tươi mới.
                    </p>
                    <button>
                        Đồ nước
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        ...
                        thanh lọc cơ thể và tăng cường sức đề kháng nhờ lượng vitamin C dồi dào. Đồ uống này mang vị
                        chua ngọt nhẹ, dễ uống và sảng khoái.
                    </p>
                    <button>
                        Đồ nước
                    </button>
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        ...
                        Đây là thức uống lý tưởng để giải nhiệt trong những ngày nắng nóng, bổ sung vitamin và khoáng
                        chất cần thiết.
                    </p>
                    <button>
                        Đồ nước
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Nước ép bưởi cà rốt kết hợp hai thành phần giàu vitamin C và beta-carotene, giúp tăng cường sức
                        khỏe và đẹp da.
                        Vị ngọt dịu từ cà rốt hòa quyện với chút chua nhẹ của bưởi, mang lại hương vị tươi ngon, bổ
                        dưỡng.
                    </p>
                    <button>
                        Đồ nước
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        ...
                        tạo nên thức uống vừa ngon miệng vừa giàu vitamin. Đồ uống này giúp tăng cường sức đề kháng và
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Nước ép táo tươi mát với hương vị ngọt thanh nhẹ nhàng, giúp cung cấp năng lượng và bổ sung
                        vitamin A, C.
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        ...
                        giàu vitamin C và tốt cho hệ tiêu hóa. Phù hợp với những ai yêu thích hương vị trái cây tự
                        nhiên.
                    </p>
                    <button>
                        Đồ nước
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Sinh tố xoài đậm đà, thơm lừng vị xoài chín, giàu chất xơ và vitamin C, mang lại cảm giác sảng
                        khoái và giải nhiệt cho cơ thể trong những ngày nắng nóng.
                    </p>
                    <button>
                        Đồ nước
                    </button>
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Sữa chua việt quất với vị chua ngọt tự nhiên, bổ sung lợi khuẩn và chất chống oxy hóa từ việt
                        quất, mang đến thức uống tốt cho sức khỏe và làn da.
                    </p>
                    <button>
                        Đồ nước
                    </button>
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Trà bạc hà thơm mát, giúp thư giãn và giảm căng thẳng. Vị mát lạnh từ bạc hà làm dịu đi sự oi
                        bức của ngày hè, đồng thời hỗ trợ tiêu hóa hiệu quả.
                    </p>
                    <button>
                        Đồ nước
                    </button>
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Trà đào ngọt ngào, kết hợp vị chua nhẹ của đào chín mọng, mang đến hương vị tươi mát và sảng
                        khoái. Thích hợp cho những ai yêu thích vị trà trái cây tự nhiên.
                    </p>
                    <button>
                        Đồ nước
                    </button>
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Trà sữa cookie là sự hòa quyện giữa vị trà sữa thơm béo và hương vị giòn tan của cookie. Một
                        thức uống ngọt ngào và thú vị dành cho các bạn trẻ.
                    </p>
                    <button>
                        Đồ nước
                    </button>
            ...
            <div class="menu-item">
                ...
                <div class="details">
                    ...
                    <p>
                        Trà hoa nhài dịu nhẹ, mang hương thơm thanh khiết giúp thư giãn và làm dịu tinh thần. Thức uống
                        thanh mát này là lựa chọn lý tưởng cho những buổi tối thư thái.
                    </p>
                    <button>
                        Đồ nước
                    </button>
